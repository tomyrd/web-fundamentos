...
export class DocentesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.docentes = _.chunk([
      ...
      {name: "Peke", url1: "assets/img/docentes/peke1.jpg", url2: "assets/img/docentes/peke2.jpg"},
      ...
      {name: "Rama", url1: "assets/img/docentes/rama1.jpg", url2: "assets/img/docentes/rama2.jpg"},
