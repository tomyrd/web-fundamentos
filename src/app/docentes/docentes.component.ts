...
export class DocentesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.docentes = _.chunk([
      ...
      { name: "Dani", url1: "assets/img/docentes/dani1.jpeg", url2: "assets/img/docentes/dani2.jpeg" },
      { name: "Flor", url1: "assets/img/docentes/flor1.jpg", url2: "assets/img/docentes/flor2.jpg" },
      { name: "Gasti", url1: "assets/img/docentes/gaston1.jpg", url2: "assets/img/docentes/gaston2.jpg" },
